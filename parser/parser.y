...
expression : /* Send */ SEND name LANGLE name COMMA name RANGLE  
		   ...
		   | /* Sync */ name LEFT_ARROW SYNC LANGLE names RANGLE SEQUENCE expression
		   			{ $$ = process.NewSync($1, $5, $8) }
